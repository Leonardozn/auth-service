...
test('password_reset_token service add() — creates and returns the contract-filtered record', async () => {
...
test('password_reset_token service findOne() — returns the contract-filtered record by id', async () => {
	seed()
	const service = Password_reset_tokenService.getInstance()
...
test('password_reset_token service list() — returns count and contract-filtered records', async () => {
	seed()
	const service = Password_reset_tokenService.getInstance()
...
test('password_reset_token service update() — patches and returns the contract-filtered record', async () => {
	seed()
	const service = Password_reset_tokenService.getInstance()
...
test('password_reset_token service replace() — replaces and returns the contract-filtered record', async () => {
	seed()
	const service = Password_reset_tokenService.getInstance()
...
test('password_reset_token service remove() — deletes the record', async () => {
	seed()
	const service = Password_reset_tokenService.getInstance()
