...
class Confirmation_codeInterfaces {
	/**
	 * @private
	 * @static
	 */
	...
	constructor() {
		...
		this.createInterface = this.dataValidatorHandler.validate({
			...
			purpose: { type: this.types.string, optional: true },
			codeHash: { type: this.types.string, optional: true },
		...
		this.queryInterface = this.dataValidatorHandler.validate({
			...
			purpose: { type: this.types.string, optional: true, transform: true, allowAdvance: true },
			codeHash: { type: this.types.string, optional: true, transform: true, allowAdvance: true },
			medium: { type: this.types.string, optional: true, transform: true, allowAdvance: true },
		...
		this.virtualsInterface = this.dataValidatorHandler.validate({
			...
			purpose: { type: this.types.string, optional: true, isVirtual: true },
			codeHash: { type: this.types.string, optional: true, isVirtual: true },
			medium: { type: this.types.string, optional: true, isVirtual: true },
	...
	static getInstance() {
		if (!this.instance) this.instance = new Confirmation_codeInterfaces()
...
module.exports = Confirmation_codeInterfaces