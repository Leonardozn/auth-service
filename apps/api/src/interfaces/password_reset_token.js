...
class Password_reset_tokenInterfaces {
	/**
	 * @private
	 * @static
	 */
	...
	constructor() {
		...
		this.createInterface = this.dataValidatorHandler.validate({
			...
			token: { type: this.types.string, optional: true },
		...
		this.queryInterface = this.dataValidatorHandler.validate({
			...
			token: { type: this.types.string, optional: true, transform: true, allowAdvance: true },
		...
		this.virtualsInterface = this.dataValidatorHandler.validate({
			...
			token: { type: this.types.string, optional: true, isVirtual: true },
	...
	static getInstance() {
		if (!this.instance) this.instance = new Password_reset_tokenInterfaces()
...
module.exports = Password_reset_tokenInterfaces